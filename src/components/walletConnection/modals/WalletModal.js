...
<div id="popup-modal" tabindex="-1" class={`${isOpen?"flex":"hidden"} bg-[#100a04e8] justify-center items-center fixed top-0 left-0 right-0 z-50  overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-0rem)] max-h-full`}>
    <div class="relative w-full max-w-xs max-h-full">
        <div class="relative bg-[#000] rounded-lg shadow">
            <div className=' flex items-center px-6  py-2'>
                <p className=' text-[#FF993C]'>WalletConnect</p>
               <button onClick={()=>onClose()} type="button" class=" bg-[#1F1307] focus:border-transparent text-sm w-10 h-10 ml-auto inline-flex justify-center items-center rounded-full text-[#FF993C]" data-modal-hide="popup-modal">
            ...
            <div class="px-4 py-2 rounded-xl bg-[#1F1307]  text-center flex items-center justify-between">
