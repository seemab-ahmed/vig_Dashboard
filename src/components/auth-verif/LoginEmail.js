    ...
    <div>
      <div className="font-mono min-h-screen flex">
        <div
          ...
          } lg:w-[30%] sm:w-[25%] hidden lg:block sm:block`}
        ></div>
            ...
            <div className="flex flex-col justify-center items-center">
              <h2 className="lg:text-[64px] text-[42px] text-[#FF993C] py-5 capitalize text-center">
                {activeTab === "tab1" ? (
                  ...
                  <>
                     <span className="px-1">CONN<span className="fontfamily">E</span>CT{" "}
                    <span className="fontfamily">W</span>ALLET</span> 
                  </>
                )}
              </h2>
              <p className="text-[#ff9a3c96] text-center">
                Select the necessary authorization option.
              </p>
            </div>
            <div className="p-4">
          ...
          {activeTab === "tab1" && (
            <div className="w-full flex items-center justify-center flex-col gap-4 lg:w-[100%] sm:w-[80%] text-center">
              ...
              <p className="text-[#ff9a3c96] ">
                ...
                <a
                  href="#"
                  className="underline underline-offset-2 text-[#FF993C]"
                >
                  Terms of use
                </a>{" "}
                and{" "}
